...
public class MaterialtypeDaoImpl extends BaseDaoImpl {
	...
	public List<CodeTableForm> getMaterialtypeList() {
		...
		String sql = "SELECT t.*, (SELECT materialtypename FROM smaterialtype WHERE materialtype = t.parent) parentname FROM smaterialtype t"
	...
	private List<CodeTableForm> getChildrenList(CodeTableForm form) {
	    ...
	    List<CodeTableForm> materialtypeList = new ArrayList<CodeTableForm>();
	    CodeTableForm codeTableForm = null;
		String sql = "SELECT t.*, (SELECT materialtypename FROM smaterialtype WHERE materialtype = t.parent) parentname FROM smaterialtype t WHERE t.parent = '"
	...
	public List<CodeTableForm> getMaterialtypeList(CodeTableForm form) {
		...
		String sql = "SELECT t.*, (SELECT materialtypename FROM smaterialtype WHERE materialtype = t.parent) parentname FROM smaterialtype t WHERE 1 = 1";
		String cond = getMaterialtypeListCondition(form);
		sql  += cond;
	...
	public CodeTableForm getMaterialtypeById(int materialtype) {
		...
		String sql = "SELECT t.*, (SELECT materialtypename FROM smaterialtype WHERE materialtype = t.parent) parentname FROM smaterialtype t WHERE t.materialtype = '"
				+ materialtype + "'";
