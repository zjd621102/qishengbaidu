...
public class ProducttypeDaoImpl extends BaseDaoImpl {
	...
	public List<CodeTableForm> getProducttypeList() {
		...
		String sql = "SELECT t.*, (SELECT producttypename FROM sproducttype WHERE producttype = t.parent) parentname FROM sproducttype t"
	...
	private List<CodeTableForm> getChildrenList(CodeTableForm form) {
	    ...
	    List<CodeTableForm> producttypeList = new ArrayList<CodeTableForm>();
	    CodeTableForm codeTableForm = null;
		String sql = "SELECT t.*, (SELECT producttypename FROM sproducttype WHERE producttype = t.parent) parentname FROM sproducttype t WHERE t.parent = '"
	...
	public List<CodeTableForm> getProducttypeList(CodeTableForm form) {
		...
		String sql = "SELECT t.*, (SELECT producttypename FROM sproducttype WHERE producttype = t.parent) parentname FROM sproducttype t WHERE 1 = 1";
		String cond = getProducttypeListCondition(form);
		sql  += cond;
	...
	public CodeTableForm getProducttypeById(int producttype) {
		...
		String sql = "SELECT t.*, (SELECT producttypename FROM sproducttype WHERE producttype = t.parent) parentname FROM sproducttype t WHERE t.producttype = '"
				+ producttype + "'";
