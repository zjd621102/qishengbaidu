...
public class MaterialDaoImpl extends BaseDaoImpl {
	...
	public List<CodeTableForm> getMaterialList(CodeTableForm form) {
		...
		String sql = "SELECT t.*, (SELECT materialtypename FROM smaterialtype WHERE materialtype = t.materialtype) materialtypename,"
				+ " (SELECT unitname FROM cunit WHERE unitid = t.unit) unitname, sm.manuname, sm.manucontact, sm.manutel"
	...
	public CodeTableForm getMaterialById(int materialid) {
		...
		String sql = "SELECT a.*, (SELECT materialtypename FROM smaterialtype WHERE materialtype = a.materialtype) materialtypename,"
				+ " (SELECT unitname FROM cunit WHERE unitid = a.unit) unitname, (SELECT manuname FROM smanu WHERE manuid = a.manuid) manuname"
