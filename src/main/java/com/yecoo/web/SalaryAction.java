...
public class SalaryAction {
	...
	public String toAdd(HttpServletRequest request) {
		...
		String sql = "SELECT t.staffid, staffname, (SELECT IFNULL(SUM(a.salary), 0) FROM bworkrow a, bwork b WHERE a.workid = b.workid AND b.staffid = t.staffid AND b.workmonth = '" + salarydate + "') planmoney FROM sstaff t WHERE t.staffstatus = '1'";
