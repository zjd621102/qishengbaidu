...
public class PublicAction {
	...
	private void setIndex(HttpServletRequest request) {
		...
		sql = "SELECT t.sellid, (SELECT manuname FROM smanu WHERE manuid = t.manuid) manuname, t.selldate FROM bsell t WHERE t.currflow <> '结束' ORDER BY t.createtime";
		...
		sql = "SELECT t.payid, (SELECT btypename FROM sbtype WHERE btype = t.btype) btypename, t.paydate FROM bpay t WHERE t.currflow <> '结束' ORDER BY t.createtime";
